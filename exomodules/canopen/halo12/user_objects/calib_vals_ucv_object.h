/**
 * @file    calib_vals_ucv_object.h
 *
 * @brief   ??? Register the calibration values object (0x5103) dictionary entries.
 *
 * Why do we have this?
...
#ifndef CALIB_VALS_UCV_OBJECT_H
#define	CALIB_VALS_UCV_OBJECT_H
