...
//#include "app.h"
#include "co_project_spec.h"
#include "app_emcy.h"
#include "app_dict.h"
#include "app_stdobj.h"

/* select application drivers: */
#include "driver/co_can_VA41630.h"      /* CAN driver                  */
#include "driver/co_timer_VA41630.h"    /* Timer driver                */
#include "driver/co_nvm_VA41630.h"      /* NVM driver                  */
...
CO_OBJ *CreateDir(void)
{
    ...
    TraceDbg(TrcMsgAlways, "OD len:%d used:%d size:%d",
