 ...
 * @file    app_stdobj.h
 *
 * @brief   ??? Macros to register the standard object dictionary entries, most of which
 * are not detailed in the ICD. Must we keep the ones that are not in the ICD? Yes
 *
 ...
 * @param   val Constant device type with device profile number (bit0 to 15) and
 ...
 * @param ref Reference to 8bit error register variable.
 */
 ...
 * @param ref Reference to 32bit manufacturer specific status register variable.
 */
 ...
 * @param refNum Reference to 8bit variable with number of actual errors.
 */
 ...
 * @param sub Subindex for this standard error field (01h to FEh)
 * @param ref Reference to standard error field with error code (bit0 to 15)
 ...
 * @param val Constant value of 32bit COB-ID with CAN-ID (bit0 to 10).
 */
 ...
 * @param ref Reference to value of 32bit COB-ID with CAN-ID (bit0 to 10).
 * @note The node-id is considered when using this object entry
 */
 ...
 * @param ref Reference to value of 16bit heartbeat time in 1 ms.
 */
 ...
 * @param val Constant value for highest sub-index (1h to 4h).
 */
 ...
 * @param val Constant vendor-id (assigned uniquely to manufacturers by CiA)
 */
 ...
 * @param val Constant product code
 */
 ...
 * @param val Constant revision number
 */
 ...
 * @param val Constant serial number
 */
 ...
 * @param srv Constant value for SDO server (0 to 127)
 * @param val Constant value for highest sub-index (2h to 3h)
 */
...
#define OBJ12XX_1(srv,ref)                                 \
    CO_KEY(0x1200 + (srv), 1, CO_UNSIGNED32|CO_OBJ_DN_RW), \
...
#define OBJ12XX_2(srv,ref)                                 \
    CO_KEY(0x1200 + (srv), 2, CO_UNSIGNED32|CO_OBJ_DN_RW), \
    CO_TSDOID, (uintptr_t)(ref)

/**
 * @brief OBJECT 14XXh:0 - RPDO COMMUNICATION PARAMETER
 * @param num Constant value for RPDO number (0 to 511)
 * @param val Constant value for highest sub-index (2h to 5h)
 */
 ...
 * @param num Constant value for RPDO number (0 to 511)
 * @param ref Reference to value of 8bit with encoded transmission type
 */
 ...
 * @param num Constant value for RPDO number (0 to 511)
 * @param ref Reference to 8bit value with number of mapped application objects in RPDO
 */
 ...
 * @param ref Reference to mapping value with an object index (bit31 to 16),
 ...
 * @param num Constant value for TPDO number (0 to 511)
 * @param ref Reference to 8bit value with encoded transmission type
 */
 ...
 * @param num Constant value for TPDO number (0 to 511)
 * @param ref Reference to 16bit value with inhibit time in 100us
 */
 ...
 * @param num Constant value for TPDO number (0 to 511)
 * @param ref Reference to 16bit value with event time in 1ms
 */
 ...
 * @param num Constant value for TPDO number (0 to 511)
 * @param ref Reference to 8bit value with number of mapped application objects in TPDO
 */
