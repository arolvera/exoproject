####################################################################################
# HARDWARE CONTROL PROJECT CONFIGURATION FILE
# This project configuration file is created to facilitate testing of individual
# hardware control components without system control.
####################################################################################
...
set(EXOPROJECT_APP_SUBTYPE "" CACHE STRING "project subtype" FORCE)
...
if(EXORUN_WITH_FIXED_RESID)
    ...
    set(EXORUN_WITH_MVCP_RESID ON CACHE BOOL "Run the Magnet + Valve mode")
    set(EXORUN_WITH_ACP_RESID ON CACHE BOOL "Run the Anode mode")
    set(EXORUN_WITH_SYS_CTRL_RESID ON CACHE BOOL "Run the Engine Control by itself")
    set(EXORUN_WITH_HRD_CTRL_RESID ON CACHE BOOL "Run the Hardware Control by itself")
    set(EXORUN_WITH_ALL_CTRL_RESID ON CACHE BOOL "Run the Engine Control + all hardware control components")
...
####################################################################################
# Single Component Settings - THIS IS ALWAYS ON FOR HARDWARE CONTROL BUILD
####################################################################################
...
if(SINGLE_COMPONENT_BUILD)
    ...
    set(EXORUN_SINGLE_COMPONENT_VALVE ON CACHE BOOL "Run the Valves by itself")
