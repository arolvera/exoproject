...
#define OUTPUT_CURRENT   8
#define INPUT_VOLTAGE    3
...
void aa_get_data(void)
{
    ...
    anode.output_current = current;
    anode.output_voltage = ca_get_value(RETURN_MEDIAN, OUTPUT_VOLTAGE);
    anode.input_voltage = ca_get_value(RETURN_MEDIAN, INPUT_VOLTAGE);
}
